...
// const skills = [
//   { name: "HTML", color: "from-red-500 to-orange-500" },
//   { name: "CSS", color: "from-blue-500 to-cyan-500" },
//   { name: "JavaScript", color: "from-yellow-400 to-yellow-600" },
//   { name: "React.js", color: "from-blue-400 to-indigo-600" },
//   { name: "Tailwind CSS", color: "from-cyan-400 to-teal-500" },
//   { name: "Bootstrap", color: "from-purple-400 to-pink-500" },
//   { name: "Git & GitHub", color: "from-gray-700 to-gray-900" },
//   { name: "Responsive Design", color: "from-green-400 to-emerald-500" },
//   { name: "Debugging", color: "from-pink-400 to-rose-500" },
//   { name: "API Integration", color: "from-indigo-400 to-violet-600" },
// ];
...
//                 glareMaxOpacity={0.3}
//                 scale={1.05}
//                 className={`rounded-xl bg-gradient-to-br ${skill.color} p-6 text-center font-semibold text-lg cursor-pointer shadow-lg hover:shadow-2xl transition-transform`}
//               >
//                 {skill.name}
//               </Tilt>
//             </motion.div>
